...
# Instead of standard predict, get the probabilities
# [:, 1] gets the probability of the "Attack" class (label 1)
y_probs = model.predict_proba(X_test_scaled)[:, 1]

# Set a custom threshold (Lower = More Sensitive/Higher Recall)
threshold = 0.3
